    ...
    <AuthCard>
      <div className="mb-6">
        <h2 className="text-2xl font-black tracking-tight sm:text-3xl">
          Create your PollIq workspace
        </h2>
        <p className="mt-2.5 text-sm leading-6 text-slate-400">
          Start building cinematic forms, AI-guided flows, and theme-driven experiences.
        </p>
      </div>
      ...
      <div className="mt-5 flex items-center justify-between gap-3 rounded-lg border border-white/10 bg-black/18 px-4 py-3 text-sm text-slate-400">
        ...
        <Link className="font-bold text-[#EC4899] transition hover:text-white" href="/sign-in">
          Sign in
        </Link>
      </div>
